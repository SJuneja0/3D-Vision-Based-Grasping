...
class MyTask(Task):
    def __init__(self, sim):
        ...
        import os
        print("CWD:", os.getcwd())
        print("Assets exists:", os.path.exists("assets/evo_bowl_compliant.urdf"))
        
        self.pb_client = self.sim.physics_client
        self.pb_client.setAdditionalSearchPath("assets/")
        # self.object_id = self.sim.loadURDF(
        #     body_name="object",
        #     fileName="evo_bowl_compliant.urdf",
